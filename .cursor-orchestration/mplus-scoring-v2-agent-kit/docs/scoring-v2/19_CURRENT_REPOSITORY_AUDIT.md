...
This audit reflects main around `0b0d911f9c4f3ec771bd8f2390e972da01595f99` and the calibration draft branch observed at `5603d4b8f01375599fa0bb71255b98d775cd8e4d`.

Re-run the audit before implementation because the repository may have moved.
...
- Planner/admission does not yet guarantee complete 2×dungeon execution before publication.
...
- no first-class immutable 2×dungeon manifest/slots;
