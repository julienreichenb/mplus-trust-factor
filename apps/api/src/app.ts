...
import { buildAdminAbilityCatalogReviewRoutes } from "./routes/admin-ability-catalog-review.js";
import { buildAdminAbilityCatalogReleaseRoutes } from "./routes/admin-ability-catalog-releases.js";
import { buildAdminAbilityCatalogReplayRoutes } from "./routes/admin-ability-catalog-replays.js";
import { buildAdminAbilityCatalogWorkflowRoutes } from "./routes/admin-ability-catalog-workflow.js";
import { buildAdminAbilityCatalogManualEditRoutes } from "./routes/admin-ability-catalog-manual-edit.js";
...
export async function buildApp(options: BuildAppOptions = {}): Promise<FastifyInstance> {
  ...
  await app.register(buildAdminAbilityCatalogReviewRoutes(container));
  await app.register(buildAdminAbilityCatalogReleaseRoutes(container));
  await app.register(buildAdminAbilityCatalogReplayRoutes(container));
  await app.register(buildAdminAbilityCatalogWorkflowRoutes(container));
  await app.register(buildAdminAbilityCatalogManualEditRoutes(container));
