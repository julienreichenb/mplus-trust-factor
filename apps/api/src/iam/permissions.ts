...
export const PERMISSIONS = {
  ...
  ADMIN_ABILITY_CATALOG_MANAGE: "admin.ability_catalog.manage",
  ADMIN_ABILITY_CATALOG_PUBLISH: "admin.ability_catalog.publish",
...
export const DEFAULT_ADMIN_PERMISSIONS: PermissionKey[] = [
  ...
  PERMISSIONS.ADMIN_ABILITY_CATALOG_MANAGE,
  PERMISSIONS.ADMIN_ABILITY_CATALOG_PUBLISH,
