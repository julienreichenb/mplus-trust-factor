...
| Architecture | [`architecture/`](architecture/) | System, refresh, parallel admission, WCL, publication, IAM, addon, frontend (incl. [ExBoss voice pack builder](architecture/frontend/exboss-voice-pack-builder.md)), [character search](architecture/character-search-and-realm-catalog.md), [Scoring](../scoring/SCORING_ARCHITECTURE.md) |
