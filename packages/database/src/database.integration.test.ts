...
describe("database integration", () => {
  ...
  it("has active default score model v6 after seed (older versions archived)", async () => {
    const v6 = await prisma.scoreModel.findUnique({
      where: { key_version: { key: "default", version: 6 } },
    });
